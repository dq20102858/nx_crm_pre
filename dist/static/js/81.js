...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/912cms/rent/officeBuilding/OfficeBuilding.vue
//
//
//
//
...
/* harmony default export */ var OfficeBuilding = ({
	name: "OfficeBuilding",
	data: function data() {
		return {
			officeList: [], //列表页的数据
	...
	methods: {
		...
		handleDelete: function handleDelete(index, row) {
			...
			this.$confirm("你确定要删除此写字楼信息吗?", "提示", {
				confirmButtonText: "确定",
				cancelButtonText: "取消",
				type: "warning"
			}).then(function () {
				Object(rent["e" /* delResidence */])({
					ids: String(row.id)
...
/* harmony default export */ var rent_officeBuilding_OfficeBuilding = __webpack_exports__["default"] = (Component.exports);
...
// load the styles
var content = __webpack_require__("YKxs");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("87b6f96a", content, true);
