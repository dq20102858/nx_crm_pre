...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/912cms/baike/BaikeCate.vue
...
/* harmony default export */ var BaikeCate = ({
  name: 'BaikeCate',
  ...
  methods: {
    ...
    addOneAdmin: function addOneAdmin(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          if (_this.isEdit) {
            Object(baike["s" /* updateBaikeCate */])(_this.searchForm).then(function (res) {
              if (res.data.status) {
                _this.$message({
            ...
            Object(baike["b" /* addBaikeCate */])(_this.searchForm).then(function (res) {
              if (res.data.status) {
                _this.$message({
                  message: res.data.msg,
                  type: 'success'
    ...
    edit: function edit(data) {
      ...
      // getBaikeCateDetail(data.id).then(res=>{
    ...
    remove: function remove(data) {
      ...
      this.$confirm("你确定要删除此条百科类别吗?", "提示", {
        ...
        _this3.$message({
          type: "success",
          message: "删除成功!",
          onClose: Object(baike["h" /* delBaikeCate */])({
            id: data.id
...
/* harmony default export */ var _12cms_baike_BaikeCate = __webpack_exports__["default"] = (Component.exports);
...
// load the styles
var content = __webpack_require__("AGAW");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("2dee4aa0", content, true);
