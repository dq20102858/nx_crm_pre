...
// load the styles
var content = __webpack_require__("oyRP");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("0cc86fac", content, true);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/912cms/rent/factory/FactoryDetail.vue
...
/* harmony default export */ var FactoryDetail = ({
	name: "Collect",
	data: function data() {
		var _this = this,
		    _ref;
		...
		return _ref = {
			...
			districts: [],
			remarkLists: []
		}, defineProperty_default()(_ref, "fileList", []), defineProperty_default()(_ref, "cellFileList", []), defineProperty_default()(_ref, "dialogFormVisible", false), defineProperty_default()(_ref, "dialogStatus", ""), defineProperty_default()(_ref, "textMap", {
			update: "编辑单元",
			create: "新增单元"
	...
	methods: {
		...
		handleCellImgRemove: function handleCellImgRemove(file, fileList) {
			...
			fileList.map(function (item, index) {
				if (item.url == file.url) {
					_this14.ruleForm.pic.splice(index, 1);
				}
			});
		},
		handlePictureCardPreview: function handlePictureCardPreview(file) {
			this.dialogImageUrl = file.show_url || file.url;
...
/* harmony default export */ var rent_factory_FactoryDetail = __webpack_exports__["default"] = (Component.exports);
